...
#define DANETLS_PKIX_TA_MASK (DANETLS_USAGE_BIT(OSSL_DANETLS_USAGE_PKIX_TA))
#define DANETLS_PKIX_EE_MASK (DANETLS_USAGE_BIT(OSSL_DANETLS_USAGE_PKIX_EE))
#define DANETLS_DANE_TA_MASK (DANETLS_USAGE_BIT(OSSL_DANETLS_USAGE_DANE_TA))
#define DANETLS_DANE_EE_MASK (DANETLS_USAGE_BIT(OSSL_DANETLS_USAGE_DANE_EE))
